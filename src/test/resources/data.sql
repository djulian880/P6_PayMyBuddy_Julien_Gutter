...
insert into user (username,email,password) values ('test','toto@pipo.com','passtest'),('test2','toto2@pipo.com','passtest'),('test3','toto3@pipo.com','passtest')
